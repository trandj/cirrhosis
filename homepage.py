...
main_title.grid(row=0, column=0, columnspan=2, pady=(10, 40), sticky="w")

subtitle = Label(
    flow,
    text="Data Set Overview",
    font=("Roboto Mono", 35, "bold"),
    bg="#e6e8f4",
    fg="black",
    anchor="nw"
)
subtitle.grid(row=1, column=0, sticky="w", padx=10, pady=(10, 20))

# Make the description expand horizontally
description = Label(
    flow,
    text=(
        "This data set contains various clinical measurements and outcomes "
        "for patients diagnosed with Cirrhosis. It includes attributes such as "
        "age, bilirubin levels, albumin concentration, and the patient’s survival status. "
        "The data is intended for medical research and predictive modeling of liver disease outcomes."
    ),
    font=("Roboto Mono", 30),
    bg="#e6e8f4",
    fg="black",
    justify="left",
    anchor="w",
    wraplength=1500  # allows it to fill most of the window width
)
description.grid(row=2, column=0, sticky="w", padx=10, pady=(0, 0))
